...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
	<div class="page-container">
		...
		<div class="row">
			<div class="col-<?php echo $grid;?>-12">
				<img src="img/630821_102.jpg" alt="Cinque Terre" usemap="#Map" class="img-thumbnail" style="width: 100%;" >
			</div>
		</div>
		...
		<div class="row">
			<div class="col-<?php echo $grid;?>-6">
				<div class="panel panel-info">
					<div class="panel-heading">ประกาศผลสอบรอบทั่วไป ปีการศึกษา 2565</div>
					<div class="panel-body">
						<div class="row">
								...
								<div class="col-<?php echo $grid;?>-10">
									<fieldset class="content-group">
										<div class="form-group">
											<label class="control-label col-<?php echo $grid;?>-6"><b style="color: #00008B">ตรวจสอบผลการสอบคัดเลือก</b></label>
											<div class="col-<?php echo $grid;?>-6">
								...
								<div class="col-<?php echo $grid;?>-2">
									<button type="submit" id="button_cilk" name="button_cilk" class="btn btn-primary" style="font-family: surafont_sanukchang; font-size: 26px">ตรวจสอบ</button>
								</div>
				...
				<div class="col-<?php echo $grid;?>-6">
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-<?php echo $grid;?>-10">
									<li>วันที่ 16 ธันวาคม 2563 ประกาศรายชื่อ เลขที่นั่งสอบ และสถานที่สอบคัดเลือกนักเรียน ห้องเรียน สสวท.</li>
									<li>วันที่ 19 ธันวามคม 2563 สอบคัดเลือกนักเรียน ห้องเรียน สสวท. เวลา 13.00-16.00 น.</li>
									<li>วันที่ 23 ธันวามคม 2563 ประกาศผลสอบคัดเลือกนักเรียน ห้องเรียน สสวท. ชั้น ม.1 และ ม.4 แผนการเรียนวิทย์-คณิต</li>
								</div>
							</div>
						</div>
					</div>				
