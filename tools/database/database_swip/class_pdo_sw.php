...
//data_sturoom->pdo
	...
	class print_level_sw{
		public $level_id;
		function __construct($level_id){
			
			$this->level_id=$level_id;
			$connpdo_evaluation=new conntopdo_evaluationto_sw("mysql");
...
//supplementary_subject
	class supplementary_subject_sw{
		public $txt_ss_t;
		public $txt_ss_l;
		public $txt_ss_year;
...
//supplementary_daysubject
	class supplementary_daysubject_sw{
...
//rc_advisor
	class rc_advisor_sw{
		...
		function __construct($txt_YearEdu,$txt_IDLevel,$txt_Room){
			...
			class supplementary_registration_sw{
				public $txt_sr_level;
				public $txt_sr_plan;
