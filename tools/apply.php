...
<head>
	...
	<!-- Theme JS files colors_primary-->
	<script src="Bootstrap 3/Template/global_assets/js/core/libraries/jquery_ui/core.min.js"></script>
	...
	<script src="Bootstrap 3/Template/global_assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	<script src="Bootstrap 3/Template/global_assets/js/plugins/forms/selects/selectboxit.min.js"></script>
	<script src="Bootstrap 3/Template/global_assets/js/plugins/forms/selects/bootstrap_select.min.js"></script>
	<script src="Bootstrap 3/Template/global_assets/js/plugins/notifications/pnotify.min.js"></script>
	<script src="Bootstrap 3/Template/global_assets/js/plugins/notifications/noty.min.js"></script>
	<script src="Bootstrap 3/Template/global_assets/js/plugins/notifications/jgrowl.min.js"></script>
		...
		<div class="page-content">
			<div class="row">
				<div class="col-<?php echo $grid;?>-12">
					<center><h1><b>สมัครเรียน ระดับชั้น <?php echo $txt_level;?> ปีการศึกษา 2565 </b></h1></center>
				</div>
			</div>
<hr>			
						...
						<fieldset class="content-group">
							<div class="form-group">
								...
								<div class="col-<?php echo $grid;?>-7">
									<div class="input-group">
							<?php
									if(isset($rc_student_admissionRow["stu_birth"])){ ?>
										<input type="text"  name="stu_birth"  class="pickadate-accessibility form-control" placeholder="คลิกเลือก วัน/เดือน/ปี เกิด" size="30"  readonly="readonly" required="required" value="<?php echo date("d-m-Y",strtotime($rc_student_admissionRow["stu_birth"]));?>">										
							<?php	}else{ ?>
										<input type="text"  name="stu_birth"  class="pickadate-accessibility form-control" placeholder="คลิกเลือก วัน/เดือน/ปี เกิด" size="30"  readonly="readonly" required="required" value="">										
							<?php	}?>	
		...
		<div class="col-<?php echo $grid;?>-4">
							<fieldset class="content-group">
								<div class="form-group">
									...
									<?php
										$stu_plan1Sql="SELECT `IDPlan`,`Name`,`LName` FROM `rc_plan` WHERE `IDPlan`!='1' and `IDPlan`!='2'  and `IDPlan`!='0' and `IDPlan`!='12' and `IDPlan`!='13' ORDER BY `rc_plan`.`plan_num` ASC";
		...
		<div class="col-<?php echo $grid;?>-4">
							<fieldset class="content-group">
								<div class="form-group">
									...
									<?php
										$stu_plan2Sql="SELECT `IDPlan`,`Name`,`LName` FROM `rc_plan` WHERE `IDPlan`!='1' and `IDPlan`!='2'  and `IDPlan`!='0' and `IDPlan`!='12' and `IDPlan`!='13' ORDER BY `rc_plan`.`plan_num` ASC";
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->		
		<div class="row">
			<div class="col-<?php echo $grid;?>-12">
				<div class="panel panel-info">
					<div class="panel-heading">เอกสารประกอบการสมัครเรียน</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-<?php echo $grid;?>-6">
								<fieldset class="content-group">
									<div class="form-group">
										<label class="control-label col-<?php echo $grid;?>-6">
											<b style="color: #00008B"> 
												<div>วิธีการนำส่งเอกสาร</div>
												<div>ประกอบการสมัครเรียน (กรุณาเลือก 1 วิธี)</div>
											</b>
										</label>							
										<div class="col-<?php echo $grid;?>-6">
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->					
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
											<div>
												<label class="radio-inline">
													<input type="radio" class="styled" name="sd_send_documents"  value="mail" checked="checked">
													<font style="font-weight: bold;">ส่งทาง E-mail : academic@regina.ac.th</font>													
												</label>
											</div>
											<div>
												<label class="radio-inline">
													<input type="radio" class="styled" name="sd_send_documents"  value="zip">
												<div style="font-weight: bold;">ส่งทางไปรษณีย์</div>
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
											<div>
												<label class="radio-inline">
													<input type="radio" class="styled" name="sd_send_documents"  value="mail">
													<font style="font-weight: bold;">ส่งทาง E-mail : academic@regina.ac.th</font>													
												</label>	
											...
											<div>
												<label class="radio-inline">
													<input type="radio" class="styled" name="sd_send_documents"  value="zip" checked="checked">
												<div style="font-weight: bold;">ส่งทางไปรษณีย์</div>
												<div>(ชื่อและที่อยู่ผู้รับ)</div>
												<div>ฝ่ายวิชาการ โรงเรียนเรยีนาเชลีวิทยาลัย</div>
												<div>เลขที่ 166 ถ.เจริญประเทศ ต.ช้างคลาน อ.เมือง จ.เชียงใหม่ 50100</div>											
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->										
							...
							<div class="col-<?php echo $grid;?>-6">
								<fieldset class="content-group">
									<div class="form-group">
										<label class="control-label col-<?php echo $grid;?>-4"><b style="color: #00008B">เอกสารประกอบการสมัครเรียน</b></label>							
										<div class="col-<?php echo $grid;?>-8">
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->			
			<?php
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_student_photo" value="yes" checked="checked">
													รูปถ่ายนักเรียน ขนาด 1.5 นิ้ว จำนวน 1 ใบ (ถ่ายไว้ไม่เกิน 6 เดือน)
												</label>
											</div>									
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->									
			<?php	}else{ ?>
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_student_photo" value="yes">
													รูปถ่ายนักเรียน ขนาด 1.5 นิ้ว จำนวน 1 ใบ (ถ่ายไว้ไม่เกิน 6 เดือน)
												</label>
											</div>									
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->										
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_student_birth" value="yes" checked="checked">
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_student_birth" value="yes">
													สำเนาสูติบัตรนักเรียน จำนวน 1 ฉบับ
												</label>
											</div>			
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->				
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_student_house" value="yes" checked="checked">
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_student_house" value="yes">
													สำเนาทะเบียนบ้านนักเรียน จำนวน 1 ฉบับ
												</label>
											</div>							
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->								
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_name_change" value="yes" checked="checked">
													สำเนาใบเปลี่ยนชื่อ-สกุล นักเรียน (ถ้ามี)
												</label>
											</div>
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->					
			<?php	}else{ ?>
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_name_change" value="yes">
													สำเนาใบเปลี่ยนชื่อ-สกุล นักเรียน (ถ้ามี)
												</label>
											</div>
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->					
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_educational_papers" value="yes" checked="checked">
													หนังสือรับรองการเป็นนักเรียนจากสถานศึกษา หรือสำเนาเอกสารแสดงผลการเรียน หรือหนังสือรับรองผลการเรียน
												</label>
											</div>
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->					
			<?php	}else{ ?>
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_educational_papers" value="yes">
													หนังสือรับรองการเป็นนักเรียนจากสถานศึกษา หรือสำเนาเอกสารแสดงผลการเรียน หรือหนังสือรับรองผลการเรียน
												</label>
											</div>
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->				
...
<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->						
			...
			<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_quota" value="yes" checked="checked">
													<font style="color: #00008B; font-weight: bold;">กรณีโควตาภายนอก ใบรับรองนักเรียนโควตาโรงเรียนเรยีนาเชลีวิทยาลัย (เฉพาะนักเรียนชั้น ป.1)</font>
												</label>
											</div>					
			<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->					
					<?php	}else{ ?>
			<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
											<div>
												<label class="checkbox-inline">
													<input type="checkbox" class="styled" name="sd_quota" value="yes">
													<font style="color: #00008B; font-weight: bold;">กรณีโควตาภายนอก ใบรับรองนักเรียนโควตาโรงเรียนเรยีนาเชลีวิทยาลัย (เฉพาะนักเรียนชั้น ป.1)</font>
												</label>
											</div>				
			<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->					
