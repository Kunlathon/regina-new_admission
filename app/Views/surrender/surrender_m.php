...
<body class="col-<?php echo $grid;?>-12" style="background-color: #00CCFF;">
	...
	<div class="row">
		<div class="col-<?php echo $grid;?>-12">	
			<div class="jumbotron text-center">
				...
				<div style="font-size: 20px;">ระดับชั้นมัธยมศึกษา&nbsp;ม.1&nbsp;และ&nbsp;ม.4</div>
			</div>		
		</div>		
	</div>
	...
	<!--<div class="row">
		<div class="col-<?php echo $grid;?>-12">	
			<div class="jumbotron text-center">
				<h1>มอบตัวนักเรียนใหม่รอบทั่วไป&nbsp;ปีการศึกษา&nbsp;</h1>
				<div style="font-size: 20px;">ระดับชั้นมัธยมศึกษา</div>
			</div>		
		</div>		
	</div>-->
