...
<!--Run img-->
	<?php include("tools/ci_wbe/run_img.php");?>
<!--Run img end-->
	...
	<div class="page-container">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-<?php echo $grid;?>-12">
					<img src="<?php echo base_url();?>/tools/img/admission_img/111-01.jpg" class="img-rounded" alt="111-01" width="100%"> 
				</div>
			</div><br>			
			<div class="row">
				<div class="col-<?php echo $grid;?>-4">
					<iframe width="100%" height="300" src="https://www.youtube.com/embed/3f7iOO-PyYE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>				
				</div>
				<div class="col-<?php echo $grid;?>-4">
					<iframe width="100%" height="300" src="https://www.youtube.com/embed/YUCDnMudtIM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>				
				</div>
				<div class="col-<?php echo $grid;?>-4">
					<iframe width="100%" height="300" src="https://www.youtube.com/embed/ngH7APOZXPE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>				
				</div>				
			</div>
