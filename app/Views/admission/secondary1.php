	...
	<div class="row">
		<div class="col-<?php echo $grid;?>-12">	
			<div class="jumbotron text-center">
				<h1>กิจกรรมการเรียนการสอน ระดับชั้นมัธยมศึกษาปีที่ 1</h1>		
			</div>		
		</div>		
	</div>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-<?php echo $grid;?>-8">
					<div><img src="<?php echo base_url();?>/tools/img/admission_img/m1/111-m1.jpg" class="img-rounded" alt="Cinque Terre" width="100%"></div>
					<div><iframe width="100%" height="500" src="https://www.youtube.com/embed/ubhtEEAipOw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
				</div>
				<div class="col-<?php echo $grid;?>-4">
					<div><img src="<?php echo base_url();?>/tools/img/admission_img/m1/m1-01.png" class="img-thumbnail" alt="Cinque Terre" width="304" height="236"></div>
					<div></div>	
					<div><img src="<?php echo base_url();?>/tools/img/admission_img/m1/m1-02.png" class="img-thumbnail" alt="Cinque Terre" width="304" height="236"></div>
					<div></div>
					<div><img src="<?php echo base_url();?>/tools/img/admission_img/m1/m1-03.png" class="img-thumbnail" alt="Cinque Terre" width="304" height="236"></div>
					<div></div>					
				</div>		
